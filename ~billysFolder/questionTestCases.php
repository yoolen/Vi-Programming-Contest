...
<?php 
	...
	foreach ($io as $i => $value) {
		...
		echo '<tr>
				  ...
				  <td><form method="post" action="editTestCase.php" style="display:inline;"><input type="hidden" name="contestID" value="'.$_POST['contestID'].'"><input type="hidden" name="qid" value="'.$value['qid'].'"><input type="hidden" name="qioid" value="'.$value['qioid'].'"><input type="submit" value="Edit" name="Edit"></form></td>
				  <td><form method="post" action="questionTestCases.php" style="display:inline;"><input type="hidden" name="contestID" value="'.$_POST['contestID'].'"><input type="hidden" name="qid" value="'.$value['qid'].'"><input type="hidden" name="qioid" value="'.$value['qioid'].'"><input type="submit" value="X" name="delete"></form></td></tr>';
	}
	if ($x==0) echo '<tr><td colspan="3">There are no test cases!</td></tr>'
?>
<tr><td colspan="5"><form method="post" action="addTestCase.php" style="display:inline;"><input type="hidden" name="contestID" value=<?php echo '"'.$_POST['contestID'].'"'; ?>><input type="hidden" name="qid" value=<?php echo '"'.$_POST['qid'].'"'; ?>><input type="submit" value="Add Test Case"></form></td></tr>
</table>
</body>
