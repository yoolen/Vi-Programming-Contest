...
<form method="post" action="questionTestCases.php"><input type="hidden" name="qid" value=<?php echo '"'.$qid.'"';?>><input type="hidden" name="contestID" value=<?php echo '"'.$_POST['contestID'].'"';?>><input type="submit" value="Add Test Cases"></form>
<form method="post" action="newQuestion.php"><input type="hidden" name="contestID" value=<?php echo '"'.$_POST['contestID'].'"'; ?>><input type="submit" value="Add Another Question"></form>
