...
CONTENT;
        ...
        echo '<a href="#" onclick="window.open(\'http://njit1.initiateid.com/imaginarium/forms/folder-form.php\', \'windowName\',\'width=400,height=400,scrollbars=no\')" class="btn btn-default btn-sm"> <span class="glyphicon glyphicon-folder-open"></span> Create new Folder </a><br><br>';
        ...
        foreach ($user_folders as $f) {
            ...
            <div class="panel panel-default">
                ...
                <div id="uf<?php echo $f['folderId'] . "" ?>" class="panel-body panel-collapse collapse">
                    ...
                    echo '<br><a href="#" onclick="window.open(\'http://njit1.initiateid.com/imaginarium/forms/new-form.php?folder='.$f['folderId'].'&folderName='.$f['name'].'\', \'windowName\',\'width=400,height=600,scrollbars=no\')" class="btn btn-default btn-sm"> <span class="glyphicon glyphicon-folder-open"></span> New File </a>  <a href="#" class="btn btn-default btn-sm"> <span class="glyphicon glyphicon-trash"></span> Delete Folder </a><br>';
...
TSET;
                    foreach ($files as $file) {
                        ...
                        echo '<td style="text-align: center;"><a href="#" onclick="window.open(\'http://njit1.initiateid.com/imaginarium/forms/rename-form.php?fileId='.$file['fileId'].'\', \'windowName\',\'width=400,height=600,scrollbars=no\')" class="btn btn-default btn-sm">Rename File <span class="glyphicon glyphicon-edit"></span></a></td>';
